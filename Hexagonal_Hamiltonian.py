...
def Junk(n1 ,n2):
    ...
    ax1.set_title('Hexagonal Fourier Transform Hamiltonian', fontsize = 128)
    ...
    ax.set_title('Graphene Lattice Fermi Diagram', fontsize = 100)
